...
- **About** (`about/page.tsx`): Fun facts cards with icons — edit the `funFacts` array to update content
- **Resume** (`resume/page.tsx`): Timeline uses `border-primary/30` left border, skill pills use cyan style
